...
another resource: https://github.com/RobertTLange/gym-hanoi
"""
...
class TohEnv(discrete.DiscreteEnv):
    ...
    def render(self, mode="human"):
        """
        Render the steps of the current policy
        """
        # TODO: customize this for the toh problem (below code taken from cliff walking problem)
