...
BITSTRING_LENGTH = 50
PROBLEM = get_flip_flop_problem(BITSTRING_LENGTH)
PLOT_PER_SEED = False
ITERATIONS = 1000

SA_RHC_MAX_ATTEMPTS = 25
MIMIC_MAX_ATTEMPTS = 6

RHC_RESTARTS = 25

GA_MAX_ATTEMPTS = 8

MIMIC_POPULATION_SIZE = 50
GA_POPULATION_SIZE = 35

RANDOM_STATE = list(range(40, 61, 1))
    ...
    for seed in RANDOM_STATE:
        ...
        Simulated Annealing
         ...
         best fitness parameters:
            Iteration  Fitness      Time  ... schedule_current_value Temperature  max_iters
        9        1000     46.0  0.246922  ...               9.975214          10       1000
        11       1000     46.0  0.324117  ...              49.837391          50       1000
